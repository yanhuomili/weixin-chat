    ...
    <div class="top">
      <mu-list>
        ...
        <mu-list-item avatar button :ripple="true">
          ...
          <mu-list-item-title>抖音</mu-list-item-title>
        </mu-list-item>
        <!--<mu-list-item avatar button :ripple="true">
			      <mu-list-item-action>
			        <mu-avatar>
			          <img class="left-img" src="../../assets/img/game.png">
			        </mu-avatar>
			      </mu-list-item-action>
			    ...
			    <mu-list-item avatar button :ripple="true">
			      <mu-list-item-action>
			        <mu-avatar>
			          <img class="left-img" src="../../assets/img/xiaochengxu.png">
			        </mu-avatar>
			      </mu-list-item-action>

  ...
  <div class="mail-list">
  	<mu-appbar style="width: 100%;" color="primary">
		    ...
		    <mu-list slot="content">
		      <mu-list-item button>
		        <mu-list-item-content>
		          <mu-list-item-title>mailList1</mu-list-item-title>
		        </mu-list-item-content>
		      </mu-list-item>
		      <mu-list-item button>
		        <mu-list-item-content>
		          <mu-list-item-title>mailList2</mu-list-item-title>
		        </mu-list-item-content>
		      </mu-list-item>
		    </mu-list>
		  </mu-menu>
		...
		<mu-tabs :value.sync="active1" inverse color="secondary" text-color="rgba(0, 0, 0, .54)"  center>
		    <mu-tab>mailList 1</mu-tab>
		    <mu-tab>mailList 2</mu-tab>
		    <mu-tab>mailList 3</mu-tab>
		  </mu-tabs>
